<!-- =====================================================
  inc/header.php  (phần đã cập nhật)
  - Giữ nguyên: loginModal, registerModal
  - Thay mới:   forgotModal → 3 bước (email → PIN → mật khẩu mới)
  - Thêm:       <script> xử lý toàn bộ luồng forgot password
====================================================== -->
