      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="border-bottom border-3 pb-3 mb-3">
            <ul class="nav nav-tabs mb-3" id="imageUploadTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="file-tab" data-bs-toggle="tab" data-bs-target="#file-upload" type="button" role="tab">Chọn tệp</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="url-tab" data-bs-toggle="tab" data-bs-target="#url-upload" type="button" role="tab">Nhập URL</button>
              </li>
            </ul>
            <div class="tab-content" id="imageUploadTabContent">
              ...
              <div class="tab-pane fade" id="url-upload" role="tabpanel">
                <form id="add_image_url_form">
                  <label class="form-label fw-bold">Thêm Ảnh từ URL</label>
                  <input type="url" name="image_url" placeholder="https://example.com/image.jpg" class="form-control shadow-none mb-3" required>
                  <button class="btn custom-bg text-white shadow-none">Thêm</button>
                  <input type="hidden" name="room_id">
                </form>
              </div>
