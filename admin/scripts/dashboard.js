function booking_analytics(period=0)
{
  console.log('Calling booking_analytics with period:', period);
...
function user_analytics(period=0)
{
  let xhr = new XMLHttpRequest();
  xhr.open("POST","ajax/dashboard.php",true);
  xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
...
window.onload = function(){
  // Đã tải dữ liệu từ PHP, không cần AJAX
  // booking_analytics();
  // user_analytics();
}