            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <select name="gender" class="form-select shadow-none" required>
                  ...
                  <option value="Nam" <?php echo ($u_fetch['gender'] == 'Nam') ? 'selected' : ''; ?>>Nam</option>
                  <option value="Nữ" <?php echo ($u_fetch['gender'] == 'Nữ') ? 'selected' : ''; ?>>Nữ</option>
                  <option value="Khác" <?php echo ($u_fetch['gender'] == 'Khác') ? 'selected' : ''; ?>>Khác</option>
                </select>
              </div>
    ...
    pass_form.addEventListener('submit',function(e){
      ...
      xhr.onload = function()
      {
        ...
        if(this.responseText == 'mismatch'){
          ...
          alert('error',"Mật khẩu phải có ít nhất 8 ký tự!");
        }
        else if(this.responseText == 'no_session'){
          alert('error',"Phiên đăng nhập hết hạn. Vui lòng đăng nhập lại!");
        }
        else if(this.responseText == 0){
